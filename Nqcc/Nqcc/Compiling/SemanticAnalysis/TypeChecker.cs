...
public class TypeChecker(SymbolTable symbols, Program program)
{
    ...
    private void CheckFunctionDeclaration(FunctionDeclaration functionDeclaration)
    {
        ...
        symbols.AddOrReplace(new Function(functionDeclaration.Name, functionDeclaration.Parameters.Length, alreadyDefined || hasBody, attributes));
    ...
    private void CheckExpression(Expression expression)
    {
        switch (expression)
        {
            case Ast.Expressions.FunctionCall functionCall:
                ...
                if (functionSymbol.ParameterCount != functionCall.Arguments.Length)
                {
