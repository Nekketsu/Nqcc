...
public class PseudoRegisterReplacer(Symbols.SymbolTable symbols, Program tacky)
{
    ...
    private Function ReplaceFunction(Function function)
    {
        ...
        symbols.AddOrReplace(new Symbols.Function(functionSymbol.Name, functionSymbol.ParameterCount, functionSymbol.IsDefined, functionSymbol.Attributes, -currentOffset));
